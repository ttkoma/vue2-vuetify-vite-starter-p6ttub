<template>
  <div class="the-note mb-3">
    <v-card :loading="important" :tile="!isDesktop" class="mx-auto" max-width="800" outlined>
      ...
      <v-list-item dense>
        ...
        <v-list-item-content>
          <v-list-item-title class="font-weight-medium blue-grey--text text--darken-3">
            Лапеев Константин</v-list-item-title
          >
