<template>
  ...
  <v-textarea v-model='noteModel.text' append-outer-icon='mdi-send' auto-grow class='text-body-2' color='green' dense
              flat hide-details placeholder='Начните писать'
              prepend-icon='mdi-attachment' row-height='1'
              solo-inverted style='line-height: 12px'
